...
type Interface interface {
	...
	Mygroup() mygroupv1alpha1.MygroupV1alpha1Interface
}
...
// Deprecated: Mygroup retrieves the default version of MygroupClient.
// Please explicitly pick a version.
func (c *Clientset) Mygroup() mygroupv1alpha1.MygroupV1alpha1Interface {
	return c.mygroupV1alpha1
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.mygroupV1alpha1, err = mygroupv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	var cs Clientset
	cs.mygroupV1alpha1 = mygroupv1alpha1.NewForConfigOrDie(c)
